...
chiefWardenSchema.pre("save", async function (next) {
...
chiefWardenSchema.methods.comparePassword = async function (enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};

// return a JWT token
chiefWardenSchema.methods.getJwtToken = function () {
